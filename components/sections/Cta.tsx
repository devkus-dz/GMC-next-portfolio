...
export default function Cta() {
  return (
    <section id="cta" className="flex flex-col text-center bg-base-100 py-16 justify-center rounded-t-xl">
        <h2 className="font-bold text-3xl">Let’s Build Your <span className="text-primary">Next Digital Product</span>  </h2>
        ...
        <div className="flex flex-row gap-4 justify-center py-3">
            <Link className="btn btn-outline" href={"mailto:email@gmail.com"}>Get in touch</Link>
